...
class Game(models.Model):
   ...
   # user = models.ForeignKey(User, default='DEFAULT lala')
    ...
    game_text = models.CharField(max_length=30)
    location_text = models.CharField(max_length=30,default='Location')
    contact_text = models.CharField(max_length=30,default='Contact')
